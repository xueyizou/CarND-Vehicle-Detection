...
def extract_features(imgs, color_space='RGB', spatial_size=(32, 32),
    ...
    for img in imgs:
        ...
        if color_space == 'RGB':
            ...
            raise Exception('unknown color space: '+color_space)
...
def generate_windows(img_shape, overlap=0.6):
    windows_all=[]

    xy_overlap=(overlap, overlap)
    y_start_stop = [400, 500] # Min and max in y to search in slide_window()
    xy_window=(64, 64)
    windows = slide_window(img_shape, x_start_stop=[None, None], y_start_stop=y_start_stop,
